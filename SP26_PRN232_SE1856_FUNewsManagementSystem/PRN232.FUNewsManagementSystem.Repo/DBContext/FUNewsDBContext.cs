...
namespace PRN232.FUNewsManagementSystem.Repo.Models;
...
public partial class FUNewsDBContext : DbContext
{
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        {
            entity.HasKey(e => e.CategoryId).HasName("PK__Category__19093A2B4A9BC6A1");
        ...
        {
            entity.HasKey(e => e.NewsArticleId).HasName("PK__NewsArti__4CD0926C0DBFA474");
            ...
            entity.HasMany(d => d.Tags).WithMany(p => p.NewsArticles)
                .UsingEntity<Dictionary<string, object>>(
                    ...
                    j =>
                    {
                        j.HasKey("NewsArticleId", "TagId").HasName("PK__NewsTag__9A875DC813B45598");
                        j.ToTable("NewsTag");
        ...
        {
            entity.HasKey(e => e.AccountId).HasName("PK__SystemAc__349DA5861E1606BE");
        ...
        {
            entity.HasKey(e => e.TagId).HasName("PK__Tag__657CFA4CBF92B782");
